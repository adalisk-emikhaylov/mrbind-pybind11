...
PYBIND11_NONLIMITEDAPI_FUNC(memoryview, memoryview_from_memory, (void *mem, ssize_t size, bool readonly), (mem, size, readonly))
PYBIND11_NONLIMITEDAPI_FUNC(memoryview, memoryview_from_buffer, (void *ptr, ssize_t itemsize, const char *format, any_container<ssize_t> shape, any_container<ssize_t> strides, bool readonly), (ptr, itemsize, format, std::move(shape), std::move(strides), readonly))
